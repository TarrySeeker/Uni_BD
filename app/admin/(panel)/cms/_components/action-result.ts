...
/**
 * Человекочитаемое сообщение по коду отказа ActionResult (для форм CMS).
 * Образец catalog/_components/action-result.ts.
 */
export function errorMessage(
  ...
  switch (result.error) {
    ...
    case 'forbidden':
      return t('errors.action.forbidden', { permission: 'cms.write' });
    case 'validation':
