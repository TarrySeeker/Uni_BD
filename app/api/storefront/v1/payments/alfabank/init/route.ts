/**
 * POST /api/storefront/v1/payments/alfabank/init — инициация онлайн-оплаты Альфа-Банка
 ...
 *
 * Отличие от нейтрального роута РОВНО одно: эквайер зафиксирован (`'alfabank'`), а не
...
export async function POST(req: Request): Promise<Response> {
  return runStorefront(
    ...
    async ({ cors }) =>
      ...
      handlePaymentInit(req, cors, 'alfabank', (res) => ({
