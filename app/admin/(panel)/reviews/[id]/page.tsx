  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div className="mt-4">
          <div className="text-gray-500 text-sm">Текст отзыва</div>
      ...
      <section className="mt-6">
        <h2 className="text-lg font-semibold text-gray-900">Ответ магазина</h2>
        <p className="mt-1 text-sm text-gray-500">
          Ответ виден на витрине под отзывом. Переводы (EN/FR) — на вкладках; текст
          отзыва покупателя не переводится.
        </p>
        <div className="mt-3">
          <ReviewReplyForm
            id={review.id}
